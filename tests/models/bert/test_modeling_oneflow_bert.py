...
from tests.test_modeling_oneflow_common import (
    ModelTesterMixin,
    floats_tensor,
    ids_tensor,
...
if True:
    ...
    from transformers import OneFlowBertForMaskedLM as BertForMaskedLM
    from transformers import OneFlowBertForMultipleChoice as BertForMultipleChoice
    from transformers import OneFlowBertForNextSentencePrediction as BertForNextSentencePrediction
    from transformers import OneFlowBertForPreTraining as BertForPreTraining
    from transformers import OneFlowBertForQuestionAnswering as BertForQuestionAnswering
    from transformers import OneFlowBertForSequenceClassification as BertForSequenceClassification
    from transformers import OneFlowBertForTokenClassification as BertForTokenClassification
    from transformers import OneFlowBertLMHeadModel as BertLMHeadModel
    from transformers import OneFlowBertModel as BertModel
    from transformers import MODEL_FOR_PRETRAINING_MAPPING    

    from transformers.models.bert.modeling_oneflow_bert import BERT_PRETRAINED_MODEL_ARCHIVE_LIST
...
class BertModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    # TODO(Liang Depeng): fix this test
